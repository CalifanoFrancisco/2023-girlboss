...
void bmp::Bitmap::getPixel(const unsigned int x, const unsigned int y, unsigned char& red, unsigned char& green, unsigned char& blue) const
{
...
bmp::rgb_t bmp::Bitmap::getPixel(const unsigned int x, const unsigned int y) const
{
    rgb_t colour;
    getPixel(x, y, colour.R, colour.G, colour.B);
    return colour;
}

int bmp::Bitmap::width() const {
    return m_width;
}

int bmp::Bitmap::height() const {
    return m_height;
}
